    ...
    <div id="/" className="flex flex-col h-screen">
      <div className="flex flex-col lg:flex-row mx-auto items-center justify-center w-full lg:w-5/6 h-full lg:h-3/4 gap-10 lg:gap-24">
        <div className="flex flex-col gap-4 lg:gap-5 w-11/12 lg:w-2/5 text-center lg:text-left">
          {/* intro stuff */}
            <p className="text-3xl lg:text-7xl font-bold lg:min-h-[4.5rem]">
              <span ref={typedRef}/>
            </p>
            <motion.div 
              ...
              viewport={{once: true }}>
              <p className="text-sm lg:text-xl font-normal"> full-stack dev | software engineering | CS @ UCI</p>
              <p className="text-sm lg:text-2xl font-extralight"> I'm a self-motivated software developer passionate <br></br> about creating and contributing to meaningful solutions.
            ...
            <ul className="flex gap-4 lg:gap-7 justify-start text-3xl sm:text-4xl lg:text-5xl mx-auto lg:mx-0">
              <Link href="https://github.com/NoNathan17" target="_blank" rel="noopener noreferrer">
                <FaGithub className="w-7 md:w-10 h-7 md:h-10 transform hover:scale-110 transition duration-300"/>
              </Link>
              <Link href="https://linkedin.com/in/nathan-ong17" target="_blank" rel="noopener noreferrer">
                <FaLinkedin className="w-7 md:w-10 h-7 md:h-10 transform hover:scale-110 transition duration-300"/>
              </Link>
              <Link href="https://drive.google.com/file/d/1KpuuGPcz9wo03Zo70ziHRnwWvi419djy/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                <FaRegFileAlt className="w-7 md:w-10 h-7 md:h-10 transform hover:scale-110 transition duration-300"/>
              </Link>
            </ul>
            </motion.div>
        </div>
